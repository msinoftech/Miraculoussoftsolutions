    ...
    <>
      ...
      <section className="py-14 sm:py-20 bg-zinc-950">
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid items-start gap-8 sm:grid-cols-2 grid-cols-1">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-red-600/20 via-black/20 to-blue-700/20 p-8">
              ...
              <p className="text-[15px] leading-8 text-white">Replace manual spreadsheets, phone coordination, disconnected tools, and slow operations with connected software systems that scale.</p>
            </div>

            <div className="grid gap-4 sm:grid-cols-2">
              {features.map((feature) => 
              <div key={feature} className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/10 p-5">
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:items-center">
            <div>
              ...
              <h2 className="text-[58px] uppercase leading-[0.94] tracking-[0.02em] sm:text-[72px] lg:text-[88px]">Built with <span className="text-red-600">scalable, secure,</span> future-ready architecture.</h2>
              <p className="text-[15px] leading-8 text-zinc-600">Modern frontend, backend, cloud, database, and DevOps technologies for logistics systems that are fast, reliable, and easy to extend.</p>
            </div>
