...
export const metadata: Metadata = {
  title: "Industries | Miraculous Soft Solutions",
  description: "Miraculous Soft Solutions provides industries to design, build, launch, and scale secure cloud-based SaaS products.",
  ...
  openGraph: {
    ...
    description: `Industries for modern cloud products, including architecture, dashboards, API engineering, deployment, and scaling.`,
...
const industryItems = [
  {
    title: "Healthcare",
    description: "Healthcare for modern cloud products, including architecture, dashboards, API engineering, deployment, and scaling.",
    href: "/industries/healthcare",
    accent: "from-blue-500 to-indigo-500",
  },
  {
    title: "Education",
    description: "Education for modern cloud products, including architecture, dashboards, API engineering, deployment, and scaling.",
    href: "/industries/education",
    accent: "from-green-500 to-lime-500",
  },
  {
    title: "Finance",
    description: "Finance for modern cloud products, including architecture, dashboards, API engineering, deployment, and scaling.",
      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-[15px] leading-8 text-zinc-600">
            We design and engineer digital products that combine business strategy, premium experience, and strong technical foundations across Healthcare, Education, Finance, and other industries.
          </p>
        ...
        <div className="relative mx-auto aspect-square w-full max-w-[320px] xl:ml-auto xl:mr-0 xl:max-w-[450px]">
          ...
          <div className="absolute left-1/2 top-1/2 h-[30%] w-[30%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-blue-200 bg-[linear-gradient(145deg,#111827,#1f2937)] text-center shadow-[0_16px_28px_rgba(20,20,20,0.18)]">
            <div className="flex h-full w-full flex-col items-center justify-center">
              ...
              <div className="font-bebas-neue text-[22px] leading-none text-white">Industries</div>
            </div>
          </div>
    ...
    <section className="relative overflow-hidden bg-white py-14 sm:py-20">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4">
        <div className="mb-10 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="font-bebas-neue text-[54px] uppercase leading-[0.9] tracking-[0.02em] text-zinc-950 sm:text-[72px] lg:text-[90px]">
              Industry <span className="text-red-600">Catalog</span>
            </h2>
            <p className="mt-3 max-w-2xl text-[15px] leading-8 text-zinc-600">
              Explore our delivery ecosystem through specialized vertical industries, each engineered for measurable business impact.
            </p>
          </div>
          <Link
            href="/contact"
        ...
        <div className="grid gap-4 lg:grid-cols-12">
          <Link href={industryItems[0].href} className="group relative col-span-12 overflow-hidden rounded-2xl border border-zinc-200 bg-[linear-gradient(145deg,#111111,#1a1a1a)] p-7 text-white shadow-[0_14px_34px_rgba(0,0,0,0.16)] lg:col-span-7">
            <div className={`absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r ${industryItems[0].accent}`} />
            ...
            <div className="text-[38px] font-extrabold leading-[1.02] tracking-[-0.02em]">{industryItems[0].title}</div>
            <p className="mt-4 max-w-xl text-[14px] leading-7 text-white/75">{industryItems[0].description}</p>
          ...
          <div className="col-span-12 grid grid-cols-1 gap-4 md:grid-cols-2 lg:col-span-5">
            <Link href={industryItems[1].href} className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md">
              <div className={`absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r ${industryItems[1].accent}`} />
              <div className="text-[24px] font-extrabold leading-[1.1] tracking-[-0.02em] text-zinc-950">{industryItems[1].title}</div>
              <p className="mt-2 text-[13px] leading-7 text-zinc-600">{industryItems[1].description}</p>
            </Link>
            <Link href={industryItems[2].href} className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-md">
              <div className={`absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r ${industryItems[2].accent}`} />
              <div className="text-[24px] font-extrabold leading-[1.1] tracking-[-0.02em] text-zinc-950">{industryItems[2].title}</div>
              <p className="mt-2 text-[13px] leading-7 text-zinc-600">{industryItems[2].description}</p>
            </Link>
          </div>

          <div className="col-span-12 grid grid-cols-1 gap-4 md:grid-cols-3">
            {industryItems.slice(3).map((industry, index) => (
              <Link key={industry.href} href={industry.href} className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-zinc-300 hover:shadow-md">
                <div className={`absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r ${industry.accent}`} />
                <div className="mb-2 text-[11px] font-bold uppercase tracking-[0.08em] text-zinc-400">
                  {String(index + 4).padStart(2, "0")}
                </div>
                <div className="text-[22px] font-extrabold leading-[1.12] tracking-[-0.02em] text-zinc-950">{industry.title}</div>
                <p className="mt-2 text-[13px] leading-7 text-zinc-600">{industry.description}</p>
