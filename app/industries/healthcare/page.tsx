...
import VerticalTabsPanel from "@/app/components/VerticalTabsPanel";
...
const services = [
    { 
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-clipboard-clock-icon lucide-clipboard-clock"><path d="M16 14v2.2l1.6 1"/><path d="M16 4h2a2 2 0 0 1 2 2v.832"/><path d="M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h2"/><circle cx="16" cy="16" r="6"/><rect x="8" y="2" width="8" height="4" rx="1"/></svg>`, 
        ...
        highlights: ["Real-time slot orchestration", "Multi-doctor calendar sync", "Automated reminders & no-show control", "Queue management with staff workflows"],
    },
    {   
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-stethoscope-icon lucide-stethoscope"><path d="M11 2v2"/><path d="M5 2v2"/><path d="M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1"/><path d="M8 15a6 6 0 0 0 12 0v-3"/><circle cx="20" cy="10" r="2"/></svg>`, 
        ...
        highlights: ["Unified patient timeline", "Prescription and follow-up workflows", "Role-based doctor and staff access", "Billing-ready consultation records"],
    },
    { 
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-video-icon lucide-video"><path d="m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"/><rect x="2" y="6" width="14" height="12" rx="2"/></svg>`, 
        ...
        highlights: ["HIPAA-ready video consultations", "Digital prescriptions and notes", "Secure chat and care follow-ups", "Remote-care workflow automation"],
    },
    { 
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-hospital-icon lucide-hospital"><path d="M12 7v4"/><path d="M14 21v-3a2 2 0 0 0-4 0v3"/><path d="M14 9h-4"/><path d="M18 11h2a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-9a2 2 0 0 1 2-2h2"/><path d="M18 21V5a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16"/></svg>`, 
        ...
        highlights: ["Department-level HMS modules", "Integrated lab, pharmacy, and billing", "Operational dashboards for admins", "Scalable multi-branch architecture"],
    },
    { 
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-brain-circuit-icon lucide-brain-circuit"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M9 13a4.5 4.5 0 0 0 3-4"/><path d="M6.003 5.125A3 3 0 0 0 6.401 6.5"/><path d="M3.477 10.896a4 4 0 0 1 .585-.396"/><path d="M6 18a4 4 0 0 1-1.967-.516"/><path d="M12 13h4"/><path d="M12 18h6a2 2 0 0 1 2 2v1"/><path d="M12 8h8"/><path d="M16 8V5a2 2 0 0 1 2-2"/><circle cx="16" cy="13" r=".5"/><circle cx="18" cy="3" r=".5"/><circle cx="20" cy="21" r=".5"/><circle cx="20" cy="8" r=".5"/></svg>`, 
        ...
        highlights: ["AI-assisted triage and routing", "Smart recommendations and alerts", "Workflow automation for care teams", "Predictive analytics and insights"],
    },
    { 
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="lucide lucide-smartphone-icon lucide-smartphone"><rect width="14" height="20" x="5" y="2" rx="2" ry="2"/><path d="M12 18h.01"/></svg>`, 
        ...
        highlights: ["Native patient and doctor experiences", "Secure authentication and session control", "Push notifications and live updates", "Offline-friendly mobile workflows"],
    },
];
...
const features = [
{ 
    icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="text-zinc-900 transition group-hover:text-white"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 7v10"/><path d="M11 7v10"/><path d="m15 7 2 10"/></svg>`, 
...
const industries = ["Hospitals", "Multi-Speciality Clinics", "Dental Clinics", "Physiotherapy Centers", "Diagnostic Labs", "Mental Wellness Clinics",];
        ...
        <section className="relative overflow-hidden bg-white py-16 sm:py-20">
            ...
            <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
                ...
                <div className="space-y-5">
                    ...
                    <h1 className="uppercase leading-[0.84] tracking-wider text-[64px] text-zinc-950 sm:text-[96px] md:text-[118px] lg:text-[132px]"><span className="text-red-600">Healthcare Software</span> for <span className="hero-outline outline-black">Clinics</span></h1>
                ...
                <div className="relative">
                    ...
                    <div className="relative rounded-2xl border border-zinc-200 bg-white shadow-2xl shadow-zinc-900/10 overflow-hidden p-3 space-y-3">
                        {/* Main Grid */}
        ...
        <section className="relative overflow-hidden py-14 sm:py-20">
            <div className="mx-auto max-w-7xl px-4">
                <div className="text-center">
                    <Subheading variant="default">Healthcare Services</Subheading>
                    <h2 className="text-[58px] uppercase text-zinc-900 leading-[0.94] tracking-[0.02em] sm:text-[72px] lg:text-[88px]">built around <span className="text-red-600">real medical workflows.</span></h2>
                    <p>We design healthcare platforms that feel simple for staff, powerful for administrators, and trustworthy for patients.</p>
                </div>

                <VerticalTabsPanel items={services} />
            </div>
        </section>
                ...
                <div className="grid items-start gap-10 lg:grid-cols-2">
                    ...
                    <div className="relative rounded-2xl border-2 border-dashed border-slate-300 bg-gradient-to-br from-slate-50 to-white p-4 shadow-2xl shadow-slate-900/10">
                        ...
                        {process.map((step, index) => (
                            <div key={step} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-red-200 hover:shadow-xl">
                                ...
                                <div className="text-base font-bold text-zinc-950">{step}</div>
                                <p>Clear execution with measurable delivery milestones.</p>
                            </div>
                        ))}
                        </div>
                    </div>
