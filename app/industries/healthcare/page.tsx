        ...
        <section className="relative overflow-hidden py-14 sm:py-20">
            <div className="mx-auto max-w-7xl px-4">
                <div className="text-center">
                    <Subheading>Healthcare Services</Subheading>
                    <h2 className="text-[58px] uppercase leading-[0.94] tracking-[0.02em] sm:text-[72px] lg:text-[88px]">Software solutions built around <span className="text-red-600">real medical workflows.</span></h2>
        ...
        <section className="relative overflow-hidden py-14 sm:py-20 bg-[var(--off)]">
            ...
            <div className="relative mx-auto grid max-w-7xl gap-12 px-4 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                <div>
                    ...
                    <Subheading>Security First</Subheading>
                    <h2 className="text-[58px] uppercase leading-[0.94] tracking-[0.02em] sm:text-[72px] lg:text-[88px]">Healthcare software must be <span className="text-red-600">secure by design,</span> not by patchwork.</h2>
        ...
        <section className="relative overflow-hidden py-14 sm:py-20">
            <div className="mx-auto max-w-7xl px-4">
                <div className="grid items-start gap-10 lg:grid-cols-2">
                    <div>
                        <Subheading>Industry Solutions</Subheading>
                        <h2 className="text-[58px] uppercase leading-[0.94] tracking-[0.02em] sm:text-[72px] lg:text-[88px]">Custom software for every <span className="text-red-600">healthcare business model.</span></h2>
