...
const services = [
{ 
  icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="text-zinc-900 transition group-hover:text-white"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>`, 
...
{ 
  icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="text-zinc-900 transition group-hover:text-white"><path d="m21 21-4.34-4.34"/><circle cx="11" cy="11" r="8"/></svg>`, 
...
{ 
  icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="text-zinc-900 transition group-hover:text-white"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="m9 16 2 2 4-4"/></svg>`, 
...
{ 
  icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><circle cx="12" cy="12" r="4"/></svg>`, 
      ...
      <section className="relative overflow-hidden py-14 sm:py-20 bg-[var(--off)]">
        ...
        <div className="mx-auto grid items-start max-w-7xl px-4 gap-12 lg:grid-cols-2">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {solutions.map((item) => (
              <div key={item} className="flex items-center gap-3 rounded-xl p-4 border border-zinc-200 bg-white transition">
                <span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-zinc-600 transition group-hover:text-white"><path d="M20 6 9 17l-5-5"/></svg></span>
            ...
            <div className="relative">
              <div className="relative space-y-4">
                {processSteps.map((step, index) => (
                  <div key={step} className="flex items-center gap-4 rounded-2xl bg-white p-5 shadow-sm">
                    ...
                    <div>
                      <div className="font-bold leading-[1.05] tracking-[-0.03em] text-zinc-900">{step}</div>
                      <p>Clear milestones, agile execution, and business-first delivery.</p>
                    </div>
                  </div>
                ))}
              </div>
