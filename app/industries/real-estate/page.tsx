...
const metrics = [
  { value: "45%", label: "Response" },
  { value: "3x", label: "Visibility" },
  { value: "60%", label: "Manual work" },
  { value: "24/7", label: "Inquiry" },
];

const processSteps = [
  {
    title: "Discovery & business mapping",
    body: "We map your business, user roles, workflows, and operational goals to define the right product scope and delivery roadmap.",
  },
  {
    title: "UX design for buyers, owners & agents",
    body: "We craft intuitive interfaces for buyers, owners, agents, and property managers with a focus on ease of use and conversion optimization.",
  },
  {
    title: "MVP platform development",
    body: "We build the first production-ready version with core features, billing flows, admin control, and real deployment readiness.",
  },
  {
  ...
  {
    title: "Support, growth & optimization",
    body: "After launch, we improve performance, add advanced modules, refine analytics, and help your real estate business scale with confidence.",
  },
];

const featureCards = [
{ 
  icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white transition group-hover:text-white"><rect width="14" height="20" x="5" y="2" rx="2" ry="2"/><path d="M12 18h.01"/></svg>`, 
  label: "Mobile-first experience", 
  text: "Smooth browsing for buyers, tenants, agents, and property managers." 
},
{ 
  icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white transition group-hover:text-white"><path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="M7 16c.5-2 1.5-7 4-7 2 0 2 3 4 3 2.5 0 4.5-5 5-7"/></svg>`, 
  label: "Actionable analytics", 
  text: "Track property views, sources, conversion rates, and sales performance." 
},
{ 
  icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white transition group-hover:text-white"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5V19A9 3 0 0 0 21 19V5"/><path d="M3 12A9 3 0 0 0 21 12"/></svg>`, 
  label: "Fast listing database", 
  text: "Organized property data, media, availability, pricing, and inventory." 
},
{ 
  icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-white transition group-hover:text-white"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>`, 
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white py-16 sm:py-20">
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
          ...
          <div className="space-y-5">
            ...
            Manage <span className="text-red-600"> Listings</span>, <span className="hero-outline outline-black">Leads</span>
            </h1>
            <p>We build premium property websites, listing portals, brokerage CRM systems, rental platforms, mobile apps, and automation workflows for modern real estate businesses.</p>
      ...
      <Card
        label="What We Build"
        title={
            <>Digital products for <span className="text-red-600"> real estate</span></>
        }
      ...
      <section className="relative overflow-hidden py-14 sm:py-20 bg-[var(--off)]">
        ...
        <div className="mx-auto grid items-start max-w-7xl px-4 gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-3">
            <Subheading variant="default">Solutions</Subheading>
            <h2 className="text-[58px] uppercase text-zinc-900 leading-[0.94] tracking-[0.02em] sm:text-[72px] lg:text-[88px]">Everything your <span className="text-red-600">real estate</span> operation needs in one ecosystem.</h2>
          </div>
          
          {/* Right Column */}
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 relative">
            {solutions.map((item) => (
              <div key={item} className="flex items-center gap-3 rounded-xl p-4 bg-white transition">
                ...
                <div className="text-sm font-medium leading-[1.05] tracking-[-0.03em] text-zinc-600">{item}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-3">
              ...
              <h2 className="text-[58px] uppercase text-zinc-900 leading-[0.94] tracking-[0.02em] sm:text-[72px] lg:text-[88px]">Designed for <span className="text-red-600">buyers, agents, admins</span>, and growth teams.</h2>
              <p>Real estate software should look premium, reduce manual work, organize property data, improve trust, and make every lead easier to convert.</p>
            </div>
            ...
            <div className="relative">
              <div className="relative space-y-4">
                {processSteps.map((step, index) => (
                  <div key={index} className="flex items-center gap-4 rounded-2xl bg-white p-5 shadow-sm">
                    ...
                    <div>
                      <div className="font-bold leading-[1.05] tracking-[-0.03em] text-zinc-900">{step.title}</div>
                      <p>{step.body}</p>
                    </div>
                  </div>
                ))}
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4 relative">
            {featureCards.map((item) => (
              <div key={item.label} className="rounded-2xl bg-white p-5 shadow-sm space-y-3">
                <div dangerouslySetInnerHTML={{ __html: item.icon }} className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-red-600 text-md font-black text-white" />
                <div className="font-bold leading-[1.05] tracking-[-0.03em] text-zinc-900">{item.label}</div>
                <p>{item.text}</p>
              </div>
            ))}
          </div>
      ...
      <BoxCard
        ...
        label=""
        title={
          <>Built for <span className="text-red-600">buyers, agents,</span> and growth teams.</>
        }
        description=""
      ...
      <CtaStrip
          title={
            <>Ready to modernize your <span className="text-zinc-950">real estate</span> business?</>
          }
