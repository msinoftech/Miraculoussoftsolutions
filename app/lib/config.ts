...
export const contactInfo = {
  ...
  phone: "91 9988274974",
  email: "info@miraculoussoft.com",
  address: "Plot No-E46, industrial area, Phase-8 Sector 72, Mohali"
};

export const socialLinks = [
  {
    link: "https://www.facebook.com/miraculoussoft",
  ...
  {
    link: "https://twitter.com/miraculous_soft",
  ...
  {
    link: "https://www.instagram.com/miraculous_soft",
  ...
  {
    link: "https://www.pinterest.com/seomiraculoussoft",
    icon: "<svg xmlns='http://www.w3.org/2000/svg' class='w-4 h-4' aria-hidden='true' fill='currentColor' viewBox='0 0 24 24'><path d='M12 2C6.48 2 2 6.48 2 12c0 4.23 2.64 7.84 6.37 9.3c-.09-.79-.17-2.01.03-2.88c.18-.79 1.16-5.03 1.16-5.03s-.3-.6-.3-1.49c0-1.4.81-2.44 1.82-2.44c.86 0 1.27.64 1.27 1.41c0 .86-.55 2.15-.83 3.34c-.24 1 .5 1.82 1.48 1.82c1.77 0 3.13-1.87 3.13-4.56c0-2.38-1.71-4.04-4.15-4.04c-2.83 0-4.49 2.12-4.49 4.31c0 .85.33 1.77.74 2.27c.08.1.09.19.07.29c-.08.32-.26 1.01-.3 1.15c-.05.18-.16.22-.36.13c-1.35-.63-2.19-2.6-2.19-4.18c0-3.4 2.47-6.53 7.13-6.53c3.74 0 6.64 2.67 6.64 6.23c0 3.72-2.35 6.72-5.61 6.72c-1.1 0-2.13-.57-2.48-1.25l-.68 2.59c-.24.94-.9 2.12-1.34 2.83c1.01.31 2.08.48 3.2.48c5.52 0 10-4.48 10-10S17.52 2 12 2z'/></svg>",
