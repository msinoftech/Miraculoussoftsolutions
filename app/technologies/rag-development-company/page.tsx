      ...
      <section className="relative overflow-hidden bg-white py-16 sm:py-20">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
          ...
          <div className="space-y-5">
            ...
            <p className="text-[15px] leading-[1.8] text-zinc-600">Scalable Retrieval-Augmented Generation with Next.js, vector databases, embeddings, and LLMs—built for accurate, grounded answers from your business knowledge.</p>
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4">
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[15px] leading-[1.8] text-zinc-600"><strong className="text-zinc-600">RAG connects LLMs to your data</strong>—so answers stay grounded in policies, docs, and operational knowledge instead of generic model memory.</p>
              
              <p className="text-[15px] leading-[1.8] text-zinc-600">We engineer <strong className="text-zinc-600">ingestion, retrieval, reranking, and citation pipelines</strong> on Next.js with production observability and eval suites.</p>
        ...
        <div className="relative mx-auto max-w-7xl px-4">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] lg:items-end">
            <div className="space-y-4">
              ...
              <h2 className="text-[58px] uppercase leading-[0.94] tracking-[0.02em] sm:text-[72px] lg:text-[88px]">
                RAG <span className="text-red-600">Tech Stack</span>
              </h2>
            ...
            <div className="rounded-2xl bg-zinc-950 p-5 text-white shadow-[0_24px_50px_rgba(15,23,42,0.14)] sm:p-6">
              ...
              <p className="text-[15px] leading-[1.8] text-zinc-400">
                Layered for grounded answers: ship fast in the UI, embed and index knowledge, retrieve with precision, and deploy with confidence.
              </p>
            </div>
          </div>
