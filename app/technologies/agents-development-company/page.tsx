  ...
  return (
    <>
        ...
        <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
          ...
          <div className="space-y-5">
            ...
            <h1 className="flex flex-wrap uppercase leading-[0.84] tracking-wider text-[64px] text-zinc-950 sm:text-[96px] md:text-[118px] lg:text-[132px]">
              ...
              <span className="hero-outline outline-black">AI Agents</span>
            </h1>
            <p>Custom AI agents for healthcare, finance, education, retail, and more—engineered with modern models, automation workflows, vector search, and production guardrails on your Miraculous stack.</p>
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4">
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/70"><strong>AI agents automate real work</strong>—support, sales, ops, and compliance—when built with retrieval, tools, memory, and guardrails instead of one-off chat demos.</p>
              <p className="text-white/70">We ship <strong>sector-specific agents</strong> with evaluation pipelines and observability so your platform scales with confidence.</p>
      ...
      <section className="bg-[var(--off)] py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mb-12">
            ...
            <h2 className="text-[58px] uppercase leading-[0.94] tracking-[0.02em] text-zinc-950 sm:text-[72px] lg:text-[88px]">Built With <span className="text-red-600">AI Agents</span></h2>
            <p>Sector-specific agents for healthcare, finance, retail, security, and more—with retrieval, tools, memory, and guardrails built for production workflows.</p>
          </div>
            ...
            {sectors.map((sector, index) => (
              <article key={sector.title} className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white transition-all duration-300 hover:-translate-y-0.5 hover:border-zinc-300 hover:shadow-[0_20px_45px_rgba(15,23,42,0.08)]" >
                <div className="flex flex-1 flex-col p-6 sm:p-7">
                  ...
                  <div className="text-xs font-bold uppercase tracking-[0.12em] text-zinc-600">Industry agent</div>
      ...
      <Process
        ...
        title={
          <>How The <span className="text-red-600">AI Agent</span> Works</>
        }
        description="From model selection to production deployment—we follow a disciplined agent engineering process with evaluation pipelines, guardrails, and monitoring."
      />
        ...
        <div className="relative mx-auto max-w-7xl px-4">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] lg:items-end">
            <div className="space-y-4">
              ...
              <h2 className="text-[58px] uppercase leading-[0.94] tracking-[0.02em] text-zinc-950 sm:text-[72px] lg:text-[88px]">Agent <span className="text-red-600">Tech Stack</span></h2>
              <p>A production architecture for agents—product UX, orchestration, retrieval and memory, and cloud delivery built as one platform, not disconnected tools.</p>
            </div>
          </div>
          ...
          <div className="mt-10 overflow-hidden rounded-2xl border border-zinc-200 bg-[var(--off)] p-4 sm:p-5">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3 px-1">
              ...
              <div className="text-sm font-semibold text-zinc-600">Product → Agents → Data → Delivery</div>
            </div>
      ...
      <BoxCard
        ...
        description="Deep AI product engineering experience, strong delivery discipline, and a focus on measurable outcomes—so your AI initiative becomes a real competitive advantage."
        headerClassName="mb-12 max-w-3xl"
      />

      <CtaStrip
        title={
          <>Ready To Build Your <span className="text-black">AI Agent?</span></>
        }
