...
export default function KubernetesDevelopmentCompanyPage() {
    ...
    <>
        <Script
          id="kubernetes-development-schema"
       ...
       <section className="relative overflow-hidden bg-white py-16 sm:py-20">
          ...
          <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
              ...
              <div className="space-y-5">
                  ...
                  <p className="text-[15px] leading-8 text-zinc-600">Build fast, scalable, and real-time backend systems using Kubernetes and modern cloud architecture.</p>
          ...
          <div className="relative mx-auto w-full max-w-7xl px-4">
            <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="relative space-y-5">
                ...
                <p className="text-[15px] leading-[1.8] text-white"><strong className="text-white">Kubernetes powers modern cloud-native infrastructure</strong>{" "} with intelligent container orchestration, automated scaling, and self-healing systems—ensuring your applications remain resilient, highly available, and performant under any workload.</p>
