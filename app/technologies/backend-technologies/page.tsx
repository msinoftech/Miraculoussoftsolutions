...
import BackendHubGraph from "@/app/components/graph/BackendHubGraph";
...
const benefits = [
    ...
    {
        no: "03",
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 17H5"/><path d="M19 7h-9"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/></svg>`,
  ...
  "@graph": [
    ...
    },
    {
      ...
      "itemListElement": features.map((tech, index) => ({
        ...
        "item": {
          "@type": "Thing",
          "@id": `${PAGE_URL}/#tech-${tech.title.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`,
          "name": tech.title,
        ...
        <section className="relative overflow-hidden bg-white py-16 sm:py-20">
            ...
            <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
                ...
                <div className="space-y-5">
                    ...
                    <span className="hero-outline outline-black">Developer</span>
                    </h1>
                    <p>Build secure, scalable, and high-performance backend systems using modern server-side technologies.</p>
                    ...
                    <span className="absolute bottom-0 right-0 h-6 w-6 rounded-br-md border-b-2 border-r-2 border-white/70" />
                      ...
                      <div className="w-full overflow-hidden rounded-xl border border-white/[0.08] bg-[#0f0f0f] shadow-2xl">
                          ...
                          <div className="flex items-center justify-between border-b border-white/[0.06] px-4 py-2">
                            ...
                            <span className="text-[11px] text-zinc-600">api/users.ts</span>
                          </div>
    ...
    "data": [
        ...
        { "id": 2, "name": "John", "role": "User" }
                    ...
                    <div className="relative space-y-4">
                        ...
                        <p className="text-white/70"><strong>Backend development is the engine behind web applications</strong>{" "} — handling business logic, data processing, and server-side operations. It ensures that applications are secure, scalable, and capable of managing complex workflows efficiently.</p>
                        <p className="text-white/70">Using technologies like <strong>Node.js, databases, and API architectures</strong>,{" "} we build robust systems that manage data, integrate services, and power seamless communication between frontend and server.</p>
                        <p className="text-white/70">Our approach focuses on <strong>performance, security, and scalability</strong>{" "} — delivering reliable backend infrastructures that support high traffic, real-time operations, and long-term product growth.</p>
        ...
        <Card
            label="Technologies"
            title={
                <>Backend <span className="text-red-600">Technologies</span></>
            }
            description="A selection of our backend technologies used to build robust backend systems."
            items={features}
        ...
        <BoxCard
            items={benefits}
            label="Backend Development Benefits"
            title={
                <>Why Modern Apps Need <span className="text-red-600">Strong Backend</span></>
            }
