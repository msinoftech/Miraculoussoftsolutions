...
const benefits = [
    ...
    {
        no: "03",
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round" class="lucide lucide-scaling-icon lucide-scaling"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M14 15H9v-5"></path><path d="M16 3h5v5"></path><path d="M21 3 9 15"></path></svg>`,
    ...
    {
        no: "04",
        icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round" class="lucide lucide-handshake-icon lucide-handshake"><path d="m11 17 2 2a1 1 0 1 0 3-3"/><path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"/><path d="m21 3 1 11h-2"/><path d="M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3"/><path d="M3 4h8"/></svg>`,
...
export default function Page() {
  return (
    ...
    <section className="relative overflow-hidden bg-white py-16 sm:py-20">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
            ...
            <div className="space-y-5">
                ...
                <p>Build high-performance, scalable, and visually stunning SaaS applications using modern frontend technologies.</p>
                ...
                <div className="relative flex min-h-[390px] items-center justify-center overflow-hidden rounded-md border border-white/[0.07] bg-[linear-gradient(135deg,rgba(26,86,219,0.09),rgba(224,32,32,0.09))] p-[32px]">
                    ...
                    <div className="w-full overflow-hidden rounded-xl border border-white/[0.08] bg-[#0f0f0f] shadow-2xl">
                        ...
                        <div className="flex items-center justify-between border-b border-white/[0.06] px-4 py-2">
                            ...
                            <span className="text-xs text-white/70">Card.jsx</span>
                        </div>
        ...
        <button className="mt-3 px-4 py-2 bg-blue-600 text-white rounded-lg">
            Get Started
                ...
                <div className="relative space-y-4">
                    ...
                    <p className="text-white/70"><strong>Frontend development is the visual and interactive layer</strong>{" "} of web applications—where design meets functionality. It focuses on building fast, responsive, and engaging user interfaces that deliver seamless user experiences across all devices.</p>
                    <p className="text-white/70">Using technologies like <strong>HTML, CSS, JavaScript, and modern frameworks</strong>,{" "} we craft dynamic interfaces with reusable components, smooth animations, and scalable architectures that enhance usability and performance.</p>
                    <p className="text-white/70">Our approach ensures <strong>pixel-perfect design, accessibility, and optimization</strong>{" "} — delivering high-performing frontends that are SEO-friendly, lightning-fast, and built for real-world scalability.</p>
    ...
    <Card
      label="Technologies"
      title={
        <>Frontend <span className="text-red-600">Technologies</span></>
      }
      description=""
      items={features}
    ...
    <BoxCard
        ...
        title={
            <>WHY MODERN APPS NEED <span className="text-red-600">POWERFUL FRONTEND</span></>
        }
