...
export default function CloudDevOpsPage() {
    ...
    return (
      <>
        <Script id="cloud-devops-schema" type="application/ld+json" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaData) }} />
        ...
        <section className="relative overflow-hidden bg-white py-16 sm:py-20">
            ...
            <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
                ...
                <div className="space-y-5">
                    <Subheading variant="default">Cloud & DevOps Services</Subheading>
                    <h1 className="flex flex-wrap uppercase leading-[0.84] tracking-wider text-[64px] text-zinc-950 sm:text-[96px] md:text-[118px] lg:text-[132px]">
                        ...
                        <span className="hero-outline outline-black">Scale</span>
                    </h1>
                    <p>Design, automate, and scale your infrastructure with modern cloud architecture and DevOps workflows that deliver speed, reliability, and performance.</p>
       ...
       <Marquee items={marqueeItems} />
          ...
          <div className="relative mx-auto w-full max-w-7xl px-4">
            <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="relative space-y-4">
                <Subheading variant="light">Why Cloud & DevOps With Us</Subheading>
                ...
                <p className="text-white/70"><strong>Cloud DevOps accelerates reliable software delivery</strong>{" "} through automated pipelines, infrastructure as code, and resilient platform engineering for modern distributed systems.</p>
                <p className="text-white/70">We build <strong>secure, scalable, and observable cloud platforms</strong>{" "} with CI/CD, container orchestration, monitoring, and DevSecOps practices that keep deployments fast, safe, and production-ready.</p>
        ...
        <Card
          label="Features"
          title={
            <>Everything a modern <span className="text-red-600">Cloud & DevOps Platform Needs</span></>
          }
          description="From scalable infrastructure to automated pipelines, we build cloud and devops platforms engineered for speed, reliability, and security."
          items={features}
        ...
        <DevelopmentProcess
          ...
          title={
              <>FROM IDEA TO <span className="text-red-600">SCALABLE CLOUD & DEVOP</span></>
          }
        ...
        <BoxCard
            ...
            title={
                <>WHY MODERN SYSTEMS NEED <span className="text-red-600">POWERFUL CLOUD & DEVOP</span></>
            }
        ...
        <CtaStrip
            title={
                <>READY TO BUILD YOUR <span className="text-black">CLOUD & DEVOP PLATFORM?</span></>
            }
