...
const benefits = [
  ...
  {
      no: "02",
      icon: `<svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M9 12a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.4 22.4 0 0 1-4 2z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 .05 5 .05" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>`,
                ...
                <div className="relative mx-auto hidden aspect-square w-full lg:block" aria-hidden="true">
                    ...
                    <div className="absolute top-1/2 left-1/2 flex w-full max-w-[250px] -translate-x-1/2 -translate-y-1/2 flex-col items-center overflow-hidden rounded-xl border border-zinc-200 bg-[linear-gradient(165deg,#ffffff,#f8fafc)] shadow-[0_16px_34px_rgba(15,23,42,0.14)]">
                      ...
                      <div className="relative z-10 mb-2 flex w-full justify-between border-b border-zinc-200 px-3 pb-3 pt-3">
                        <div>
                          <div className="text-[10px] font-semibold uppercase tracking-[0.12em] text-zinc-600">Cloud Architecture</div>
                      ...
                      <div className="relative z-10 w-full space-y-3 px-3 pb-3">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="text-[9px] font-semibold text-zinc-600 uppercase">Edge Network</div>
                        ...
                        <div className="rounded-lg border border-zinc-200 bg-gradient-to-br from-white to-slate-50 p-3">
                          <div className="mb-2 text-[10px] font-semibold text-zinc-600 uppercase">Kubernetes Cluster</div>
