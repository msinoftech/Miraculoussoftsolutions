...
export default function RbacDevelopmentCompanyPage() {
    ...
    <>
      {/* Schema.org */}
      <Script id="rbac-development-company-schema" type="application/ld+json" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaData) }}/>
       ...
       <section className="relative overflow-hidden bg-white py-16 sm:py-20">
            ...
            <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
                ...
                <div className="space-y-5">
                    ...
                    <p>Protect your product with Role-Based Access Control—clean roles, least-privilege permissions, strong enforcement, and audit-ready governance.</p>
          ...
          <div className="relative mx-auto w-full max-w-7xl px-4">
            <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="relative space-y-4">
                ...
                <p className="text-white/70">RBAC keeps access simple, auditable, and secure by assigning permissions to roles and roles to users. It reduces risk, supports least privilege, and makes governance manageable across teams.</p>
                
                <p className="text-white/70">We implement role design, permission taxonomy, enforcement in APIs, admin tooling, and audit trails so access stays correct—even as your product grows and org structures change.</p>
