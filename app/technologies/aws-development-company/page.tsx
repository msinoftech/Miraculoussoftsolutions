...
export default function AWSDevelopmentCompanyPage() {
    ...
    <>
       ...
       <section className="relative overflow-hidden bg-white py-16 sm:py-20">
            ...
            <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:items-center lg:gap-12 xl:gap-14">
                ...
                <div className="space-y-5">
                    ...
                    <p>Build fast, scalable, and real-time backend systems using AWS and modern cloud architecture.</p>
          ...
          <div className="relative mx-auto w-full max-w-7xl px-4">
            <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="relative space-y-5">
                ...
                <p className="text-white/70"><strong>AWS powers modern cloud infrastructure</strong>{" "} with highly scalable, secure, and distributed systems—enabling businesses to deploy applications faster, handle massive traffic seamlessly, and ensure high availability across global regions.</p>
                <p className="text-white/70">We leverage <strong>AWS services like Lambda, EC2, S3, ECS, EKS, and CI/CD pipelines</strong>{" "} to build cloud-native solutions that are resilient, cost-efficient, and optimized for performance at scale.</p>
       ...
       <Process
        ...
        <CtaStrip
            title={
                <>Ready To Build Your <span className="text-black">AWS Project?</span></>
            }
