        ...
        <div className="overflow-hidden">
          ...
          <div className="grid gap-4">
            <div className="grid grid-cols-3 gap-3">
              {inventory.map((item) => (
                <div key={item.type} className="rounded-2xl border border-white/10 bg-white/[0.06] p-3 shadow-sm">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] py-4">
              ...
              <div className="space-y-3">
                {leadRows.map(([name, status, price, width]) => (
                  <div key={name} className="rounded-2xl bg-white p-4 text-slate-950 shadow-sm">
