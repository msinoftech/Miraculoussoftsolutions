    ...
    <section className="relative overflow-hidden py-14 sm:py-20">
      <div className="relative mx-auto max-w-7xl px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden">
          <div className="relative flex flex-col justify-center p-8 sm:p-10 lg:p-12 bg-zinc-950">
              ...
              <div className="space-y-1 pt-6">
                <a href={`mailto:${contactInfo.email}`} className="group flex items-start gap-3 rounded-lg border p-2 transition border-white/10 bg-white/[0.04]">
                  ...
                  <span className="min-w-0 pt-0.5">
                    <span className="block text-[12px] font-bold uppercase tracking-[0.14em] text-white/70">Email</span>
                    <span className="mt-0.5 block text-[15px] leading-snug text-white/70 transition group-hover:text-white">{contactInfo.email}</span>
                  </span>
                </a>
              </div>
            </div>
          ...
          <div className="relative border-t border-white/10 bg-[var(--off-2)] p-8 sm:p-10 lg:border-l lg:border-t-0 lg:p-12 overflow-hidden">
            ...
            <div className="relative mb-4">
              ...
              <div className="text-xl font-bold tracking-[-0.02em] text-zinc-950">Send Your Brief</div>
              <p>Fields marked required help us respond faster.</p>
            </div>
            <Contactform />
          </div>
        </div>
