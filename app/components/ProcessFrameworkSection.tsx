            ...
            <div className="relative z-10">
              <div className="mb-8 flex items-center justify-between gap-5">
                <div className="rounded-xl bg-zinc-950 px-6 py-5 text-white shadow-xl shadow-zinc-950/20">
                  ...
                  <div className="font-bebas-neue text-[50px] leading-none tracking-wide text-white">{active.id}</div>
                </div>
                <div className="rounded-full border border-red-200 bg-red-50 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.14em] text-red-700">{active.tag}</div>
              </div>

              <div className="text-[26px] font-bold tracking-[-0.02em] text-zinc-900">{active.title}</div>
              ...
              <div className="mt-9 rounded-xl bg-zinc-950 p-6 text-white">
                <div className="mb-4 flex gap-3">
                  ...
                  <div>
                    <div className="text-[11px] font-bold uppercase tracking-[0.12em] text-white">{signalTitle}</div>
                    <div className="text-[18px] font-bold tracking-[-0.02em]">{signalText}</div>
                  </div>
                </div>
                <div className="h-2 overflow-hidden rounded-full bg-zinc-200">
                  <div className="h-full rounded-full bg-red-600" style={{ width: `${((resolvedActiveIndex + 1) / items.length) * 100}%` }} />
                </div>
              </div>
            </div>
          </div>
