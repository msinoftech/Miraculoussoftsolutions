        ...
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`group flex w-full items-center gap-4 rounded-2xl border p-5 text-left transition duration-300 hover:-translate-y-1 ${
                active
            ...
            >
              <div
                className={`grid h-12 w-12 shrink-0 place-items-center rounded-2xl ${
                  active ? "bg-red-600 text-white" : "bg-zinc-100 text-zinc-700"
                }`}
              >
              ...
              <div
                className={`text-2xl transition group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-red-600 ${
                  active ? "text-red-600" : "text-[var(--border)]"
                }`}
              >
                ↗
              </div>
