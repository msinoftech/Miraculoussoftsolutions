  ...
  "@graph": [
    {
      ...
      "url": `${BASE_URL}`,
      "name": `${APP_NAME}`,
      "description": `${APP_NAME} provides services for modern cloud products, including architecture, dashboards, API engineering, deployment, and scaling.`,
      "potentialAction": {
        "@type": "SearchAction",
    ...
    },
    {
      ...
      "inLanguage": "en-US",
      "description": `Services by ${APP_NAME} to design, build, launch, and scale modern cloud products.`,
      "isPartOf": {
        "@id": `${BASE_URL}#website`
      },
      "about": {
...
export default function ServicesPage() {
  return (
    ...
    <Script id="services-schema" type="application/ld+json" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(servicesSchemaData, null, 2) }} />
